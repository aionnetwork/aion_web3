...
describe('web3-eth-abi', function() {
    describe('decodeParameter', function() {
        var test = function(t) {
            ...
            try {
                result = coder.decodeParameter(type, value);
            } catch (err) {
                console.log('type', type)
                // console.log('value', value)
                // console.log('expected', expected)
            ...
            it('should turn ' + type + ': ' + value + ' to ' + expected, function() {
...
describe('lib/solidity/coder', function() {
    describe('decodeParams', function() {
        ...
        test({
            ...
            expected: [[[address01a, address02a]], false],
            values: address01b +
                address02b +
                abiBoolFalse
        });
        ...
        /*test({
            ...
            values: ''
        })*/
        /*test({
