...
contract Types {
    ...
    function superCrazy1(address[2][] a) constant returns (address[2][]) { return a; }

    function superCrazy2(address[2][2] a) constant returns (address[2][2]) { return a; }

    function superCrazy3(address[2][2] a, address[2][2] b) 
    constant returns (address[2][2], address[2][2]) { return (a,b); }
